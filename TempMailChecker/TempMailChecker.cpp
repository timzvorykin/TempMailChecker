...
// TempMailChecker.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTempMailCheckerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CTempMailCheckerApp

CTempMailCheckerApp::CTempMailCheckerApp()
{
...
// Единственный объект CTempMailCheckerApp

CTempMailCheckerApp theApp;


// Инициализация CTempMailCheckerApp

BOOL CTempMailCheckerApp::InitInstance()
{
